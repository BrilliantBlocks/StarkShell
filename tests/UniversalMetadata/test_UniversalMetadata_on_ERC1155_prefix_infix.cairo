...
func __setup__{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> () {
    ...
    tempvar calldata: felt* = new (9, 0, 0, 0, TestData.SIZE, data.prefix1, data.prefix2, TRUE, 0, 0,);
    let calldata_len = 10;
...
@external
func test_uri_returns_prefix_infix_on_minted_token{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() {
    alloc_locals;
    let setup = getSetup();
    let data = getTestData();
...
@external
func test_uri_returns_prefix_infix_on_not_minted_token{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() {
    alloc_locals;
    let setup = getSetup();
    let data = getTestData();
