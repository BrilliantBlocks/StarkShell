...
func returnCalldata() -> (res_len: felt, res: felt*) {
    ...
    tempvar instruction0 = Instruction(
        Primitive(0, return_keyword), Variable(var0_identifier, 0, 0, 0), NULLvar, NULLvar
    );
    ...
    tempvar felt_code: felt* = new (total_len, instruction_len, instruction0, memory_layout);
